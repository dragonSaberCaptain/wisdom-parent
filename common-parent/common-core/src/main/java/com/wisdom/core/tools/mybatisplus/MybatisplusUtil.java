package com.wisdom.core.tools.mybatisplus;
...
public class MybatisplusUtil {
    public static void autoCreateCode(AutoCodeDto autoCodeDto) {
        ...
        //是否使用swagger2
        gc.setSwagger2(autoCodeDto.getOpenSwagger());
        //是否覆盖文件
        gc.setFileOverride(autoCodeDto.getFileOverride());
        // 主键策略
        ...
        InjectionConfig cfg = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                this.setMap(JSON.parseObject(JSON.toJSONString(autoCodeDto.getCustomAddExt()), new TypeToken<Map<String, Object>>() {
                }.getType()));
            }
        };
...
//        strategy.setSuperEntityColumns("myTest");
        ...
        if (autoCodeDto.getCustomAddExt().getOpenExt()) {
            ...
            // 生成的扩展文件不覆盖原来已存在的文件
            gc.setFileOverride(autoCodeDto.getCustomAddExt().getFileOverride());
