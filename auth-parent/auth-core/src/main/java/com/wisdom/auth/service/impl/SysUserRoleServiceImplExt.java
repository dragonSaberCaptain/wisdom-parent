...
import com.wisdom.auth.entity.SysUserRoleExt;
...
@Slf4j
@Service
public class SysUserRoleServiceImplExt extends BaseServiceImpl<SysUserRoleDaoExt, SysUserRoleExt> implements SysUserRoleServiceExt {
    @Autowired
